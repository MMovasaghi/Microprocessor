...
void USBHW::DMA_Enable (uint32_t EPNum) {
  LPC_USB->EpDMAEn = PowOf2[EPAdr(EPNum)];
}
...
void USBHW::DMA_Disable (uint32_t EPNum) {
  LPC_USB->EpDMADis = PwOf2[EPAdr(EPNum)];
}
